...
{{--                            <a class="dropdown-item text-white lightHover mt-1" id="point_of_sale_link" href="{{ route('tools.point_of_sale') }}">{{ __('Point Of Sale') }}</a>--}}
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right bg-primary" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item text-white lightHover" href="{{ route('reports.inventory-reservations.index', ['filter[warehouse_code]' =>  data_get(Auth::user(), 'warehouse.code'), 'sort' => '-created_at']) }}">{{ __('Inventory Reservations') }}</a>
