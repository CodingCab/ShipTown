<template>
    <b-modal body-class="ml-0 mr-0 pl-1 pr-1" id="product-modal" size="xl" scrollable no-fade>
        <product-card v-if="product" :product="product" :expanded="true" :show-card-border="false"/>
